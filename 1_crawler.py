...
def crawl_samyang_sitemap():
    ...
    options = webdriver.ChromeOptions()   # 웹을 띄우기 위한 options
    ...
    target_url = "https://www.samyang.co.kr/kr/index"
    menu_list = []
    try:
        ...
        menu_elements = driver.find_elements(By.CSS_SELECTOR, "#allMenu .menu_cont li.depth1 > a")
...
if __name__ == "__main__":   # 직접 파이썬 파일을 내가 열었다면(python 1_crawler.py), 실행해라
